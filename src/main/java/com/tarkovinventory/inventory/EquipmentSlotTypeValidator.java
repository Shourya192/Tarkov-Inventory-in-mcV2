...
public final class EquipmentSlotTypeValidator {
    ...
    static {
        ...
        // RIG: tactical rig — accept anything
        registerValidator(EquipmentSlotType.RIG, stack -> true);
        ...
        // BACKPACK: custom Tarkov slot — accept anything
        registerValidator(EquipmentSlotType.BACKPACK, stack -> true);
