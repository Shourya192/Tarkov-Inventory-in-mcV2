...
public final class RigStorageBlocker {
    ...
    public static void onContainerOpen(PlayerContainerEvent.Open event) {
        ...
        // Not targeting a block → this menu was opened by an item/keybind. If the
        // player has a managed rig/backpack in hand OR anywhere in their inventory,
        // assume it's that item's native storage and close it.
