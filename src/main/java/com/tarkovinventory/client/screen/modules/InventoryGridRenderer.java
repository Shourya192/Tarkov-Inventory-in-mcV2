...
public class InventoryGridRenderer {
    ...
    public void render(GuiGraphics g) {
        ...
        if (rigEquipped) {
            ...
            // No rig equipped — single grey placeholder cell with hint text
            drawSlotCell(g, left, rigY, false);
            Minecraft.getInstance().font.drawInBatch(
                "no rig equipped", left + CELL + 4, rigY + 4,
                0xFF404040, false,
                g.pose().last().pose(),
        ...
        if (bpEquipped) {
            ...
            drawSlotCell(g, left, bpY, false);
            Minecraft.getInstance().font.drawInBatch(
                "no backpack equipped", left + CELL + 4, bpY + 4,
                0xFF404040, false,
                g.pose().last().pose(),
                g.bufferSource(), net.minecraft.client.gui.Font.DisplayMode.NORMAL, 0, 0xF000F0);
        }
