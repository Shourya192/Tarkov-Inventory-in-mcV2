    ...
    private void drawSearchOverlay(GuiGraphics g) {
        ...
        for (int i = 0; i < TarkovInventoryMenu.LOOT_SLOTS; i++) {
            ...
            if (i == currentSlot) {
                ...
                // ── Slot not yet searched — completely hide item ──────
                // Solid dark grey block: item icon is invisible underneath.
                // Player sees a grey square — they know something is there
                // but can't identify it until the slot is searched.
