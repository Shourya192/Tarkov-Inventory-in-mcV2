...
public class TarkovInventoryScreen extends AbstractContainerScreen<TarkovInventoryMenu> {
    ...
    protected void renderBg(@NotNull GuiGraphics g, float partialTick, int mouseX, int mouseY) {
        ...
        rightPanel.render(g, rightScreenX, screenTopY,
                ...
                menu.searchData.get(TarkovInventoryMenu.BITMASK_ENTRIES),      // currentSlot (-1 = all done)
                menu.searchData.get(TarkovInventoryMenu.BITMASK_ENTRIES + 2)); // required ticks
    ...
    private void drawSearchOverlay(GuiGraphics g) {
        ...
        int currentSlot = menu.searchData.get(TarkovInventoryMenu.BITMASK_ENTRIES);
        int progress    = menu.searchData.get(TarkovInventoryMenu.BITMASK_ENTRIES + 1);
        int required    = menu.searchData.get(TarkovInventoryMenu.BITMASK_ENTRIES + 2);
