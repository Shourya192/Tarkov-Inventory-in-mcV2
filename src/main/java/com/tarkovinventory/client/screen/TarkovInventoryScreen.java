...
public class TarkovInventoryScreen extends AbstractContainerScreen<TarkovInventoryMenu> {
    ...
    /**
     * Never report a slot as hovered if it is inactive.
     * Without this, pre-allocated backpack/rig slots at fixed positions can be
     * highlighted even when nothing is equipped (isActive()=false).
     */
    @Override
    protected boolean isHovering(@NotNull net.minecraft.world.inventory.Slot slot,
