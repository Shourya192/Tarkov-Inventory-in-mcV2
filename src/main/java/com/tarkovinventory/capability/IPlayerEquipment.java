 ...
 *
 * MELEE, PRIMARY, SECONDARY and SIDEARM weapons are stored directly on the
 * hotbar (slots 0-3) so they are usable in-game without any extra sync.
 * Pocket slots 0-4 are backed by hotbar slots 4-8.
 *
