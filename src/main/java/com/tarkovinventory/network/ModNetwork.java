...
public final class ModNetwork {
    ...
    public static void register() {
        ...
        // ── Admin item-type tagging ─────────────────────────────────
        CHANNEL.registerMessage(id++, C2SSetItemTypePacket.class,
                C2SSetItemTypePacket::encode,
                C2SSetItemTypePacket::decode,
                C2SSetItemTypePacket::handle);

        CHANNEL.registerMessage(id++, S2COpenAdminTagPacket.class,
                S2COpenAdminTagPacket::encode,
                S2COpenAdminTagPacket::decode,
                S2COpenAdminTagPacket::handle);
    }
}
