...
public class TarkovInventoryMenu extends AbstractContainerMenu {
    ...
    private void createAllSlots() {
        ...
        // Weapon slots moved below the silhouette (y+180 / y+202) to match the renderer.
        addSlot(new Slot(playerInventory, 0, EC1, 180));
        addSlot(new Slot(playerInventory, 1, EC1, 202));
