...
public class TarkovInventoryMenu extends AbstractContainerMenu {
    ...
    private void createAllSlots() {
        ...
        final int weapGap = 2; // must match EquipmentPanelRenderer.GAP
        int weapWideW = CELL * 2 + weapGap;
        int weapSmallX = EC1 + weapWideW + weapGap;
        int weapRow2Y  = 180 + CELL + weapGap;
