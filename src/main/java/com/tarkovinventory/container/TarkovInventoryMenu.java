 ...
 *   [148 .. 154]               Tarkov custom equipment (face, ear, rig, pants, knees, armband, backpack)
 *   [155 .. 181]               player main inventory (3×9 = 27)
 *   [182 .. 190]               hotbar (9)
 *   [191 .. 191+rigCount-1]    rig panel slots (dynamic)
 *   [191+rigCount ..]          backpack panel slots (dynamic)
 *
...
public class TarkovInventoryMenu extends AbstractContainerMenu {
    ...
    // Custom equipment slot indices within the EQUIP section (menu indices = CUSTOM_EQUIP_START + offset)
    public static final int EQUIP_FACE     = 0; // IPlayerEquipment.SLOT_FACE
    public static final int EQUIP_EAR      = 1; // IPlayerEquipment.SLOT_EARPIECE
    public static final int EQUIP_RIG      = 2; // IPlayerEquipment.SLOT_RIG
    public static final int EQUIP_PANTS    = 3; // IPlayerEquipment.SLOT_PANTS
    public static final int EQUIP_KNEES    = 4; // IPlayerEquipment.SLOT_KNEES
    public static final int EQUIP_ARMBAND  = 5; // IPlayerEquipment.SLOT_ARMBAND
    public static final int EQUIP_BACKPACK = 6; // IPlayerEquipment.SLOT_ON_BACK
    ...
    public TarkovInventoryMenu(int windowId, Inventory playerInv, int ignoredHand) {
        ...
        // In Minecraft 1.20.1, playerInv as Container maps:
        //   0-8 = hotbar, 9-35 = main, 36-39 = armor, 40 = offhand
        addSlot(new TarkovSlot(playerInv, 36, -2000, -2000, EquipmentSlotType.HEAD));   // helmet
        addSlot(new TarkovSlot(playerInv, 37, -2000, -2000, EquipmentSlotType.ARMOR));  // chestplate
        addSlot(new TarkovSlot(playerInv, 38, -2000, -2000, EquipmentSlotType.PANTS));  // leggings
        addSlot(new TarkovSlot(playerInv, 39, -2000, -2000, EquipmentSlotType.BOOTS));  // boots

        // ── 3. Custom Tarkov equipment slots ─────────────────────
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_FACE,    -2000, -2000, EquipmentSlotType.FACE));
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_EARPIECE,-2000, -2000, EquipmentSlotType.EAR));
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_RIG,     -2000, -2000, EquipmentSlotType.RIG));
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_PANTS,   -2000, -2000, EquipmentSlotType.PANTS));
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_KNEES,   -2000, -2000, EquipmentSlotType.KNEE));
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_ARMBAND, -2000, -2000, EquipmentSlotType.UNKNOWN));
        addSlot(new TarkovSlot(equipContainer, 4 + IPlayerEquipment.SLOT_ON_BACK, -2000, -2000, EquipmentSlotType.BACKPACK));
        ...
        // ── 6. Rig slots (dynamic count from equipped rig item) ─────
        ...
        // ── 7. Backpack panel slots (dynamic — separate from grid) ──
    ...
    public @NotNull ItemStack quickMoveStack(@NotNull Player player, int index) {
        ...
        if (index < GRID_MAX) {
            // Grid → vanilla armor → custom equip → player inventory → hotbar
