...
public class TarkovInventoryMenu extends AbstractContainerMenu {
    ...
    private TarkovInventoryMenu(int windowId, Inventory playerInv, ConstructorArgs a) {
        ...
        // Backpack grid always sits below a reserved rig area of DEFAULT_ROWS height,
        // so slot positions never shift when the rig is equipped/unequipped.
        int reservedRigRows   = com.tarkovinventory.inventory.RigSizes.DEFAULT_ROWS;
    ...
    private void createAllSlots() {
        ...
        int pocketRowY    = gearY + CELL + 16 + LABEL_H - 2;            // renderer pocketCellY
